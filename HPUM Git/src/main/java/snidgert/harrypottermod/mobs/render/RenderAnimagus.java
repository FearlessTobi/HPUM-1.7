...
public class RenderAnimagus extends RenderLiving
{
	...
	public RenderAnimagus(final ModelBase p_i1262_1_, final float p_i1262_2_) {
	...
	public void renderPlayer(final EntityPlayer entity, final double par2, final double par4, final double par6, final float par8, final float par9) {
		super.doRender(entity, par2, par4, par6, par8, par9);
	}

	public void doRenderLiving(final EntityPlayer par1EntityLiving, final double par2, final double par4, final double par6, final float par8, final float par9) {
