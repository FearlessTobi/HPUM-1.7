...
public class EntityPatronus extends EntityWolfBase {
	...
	public EntityPatronus(final World par1World) {
		...
		targetTasks.addTask(4, new EntityAINearestAttackableTarget(this, EntityLiving.class, 0, true, false, IMob.mobSelector));
		setTamed(false);
	}
	...
	protected void func_145780_a(final int p_145780_1_, final int p_145780_2_, final int p_145780_3_, final Block p_145780_4_) {
		playSound("mob.horse.step", 0.15f, 1.0f);
	}
	...
	public void onUpdate() {
		super.onUpdate();
		final List list1 = worldObj.getEntitiesWithinAABB(EntityLiving.class,
				AxisAlignedBB.getBoundingBox(posX, posY, posZ, posX + 1.0, posY + 1.0, posZ + 1.0).expand(1.0, 1.0, 1.0));
