...
public class EntityHandler
{
    ...
    public static void registerHippogriff(final Class entityclass, final String name) {
        ...
        final int subColor = random.nextInt() * 16777215;
        EntityRegistry.registerGlobalEntityID(entityclass, name, EntityId);
        EntityRegistry.addSpawn(entityclass, 8, 1, 5, EnumCreatureType.creature, new BiomeGenBase[] { BiomeGenBase.iceMountains, BiomeGenBase.sky, BiomeGenBase.extremeHills, BiomeGenBase.extremeHillsEdge, BiomeGenBase.extremeHillsPlus, BiomeGenBase.forest, BiomeGenBase.birchForest, BiomeGenBase.birchForestHills, BiomeGenBase.megaTaiga, BiomeGenBase.megaTaigaHills, BiomeGenBase.taiga, BiomeGenBase.taigaHills });
        EntityRegistry.registerModEntity(entityclass, name, EntityId, MainClass.instance, 64, 1, true);
        EntityList.entityEggs.put(EntityId, new EntityList.EntityEggInfo(EntityId, mainColor, subColor));
    }
    ...
    public static void registerWingedHorse(final Class entityclass, final String name) {
        ...
        final int subColor = random.nextInt() * 16777215;
        EntityRegistry.registerGlobalEntityID(entityclass, name, EntityId);
        EntityRegistry.addSpawn(entityclass, 10, 1, 4, EnumCreatureType.creature, new BiomeGenBase[] { BiomeGenBase.iceMountains, BiomeGenBase.sky, BiomeGenBase.extremeHills, BiomeGenBase.extremeHillsEdge, BiomeGenBase.extremeHillsPlus, BiomeGenBase.forest, BiomeGenBase.birchForest, BiomeGenBase.birchForestHills, BiomeGenBase.megaTaiga, BiomeGenBase.megaTaigaHills, BiomeGenBase.taiga, BiomeGenBase.taigaHills });
        EntityRegistry.registerModEntity(entityclass, name, EntityId, MainClass.instance, 64, 1, true);
        EntityList.entityEggs.put(EntityId, new EntityList.EntityEggInfo(EntityId, mainColor, subColor));
    }
    ...
    public static void registerThestral(final Class entityclass, final String name) {
        ...
        final int subColor = random.nextInt() * 16777215;
        EntityRegistry.registerGlobalEntityID(entityclass, name, EntityId);
        EntityRegistry.addSpawn(entityclass, 15, 2, 4, EnumCreatureType.creature, new BiomeGenBase[] { BiomeGenBase.iceMountains, BiomeGenBase.sky, BiomeGenBase.extremeHills, BiomeGenBase.extremeHillsEdge, BiomeGenBase.extremeHillsPlus, BiomeGenBase.forest, BiomeGenBase.birchForest, BiomeGenBase.birchForestHills, BiomeGenBase.megaTaiga, BiomeGenBase.megaTaigaHills, BiomeGenBase.taiga, BiomeGenBase.taigaHills });
        EntityRegistry.registerModEntity(entityclass, name, EntityId, MainClass.instance, 64, 1, true);
        EntityList.entityEggs.put(EntityId, new EntityList.EntityEggInfo(EntityId, mainColor, subColor));
    }
    ...
    public static void registerGriffin(final Class entityclass, final String name) {
        ...
        final int subColor = random.nextInt() * 16777215;
        EntityRegistry.registerGlobalEntityID(entityclass, name, EntityId);
        EntityRegistry.addSpawn(entityclass, 9, 1, 2, EnumCreatureType.creature, new BiomeGenBase[] { BiomeGenBase.iceMountains, BiomeGenBase.sky, BiomeGenBase.extremeHills, BiomeGenBase.extremeHillsEdge, BiomeGenBase.extremeHillsPlus, BiomeGenBase.forest, BiomeGenBase.birchForest, BiomeGenBase.birchForestHills, BiomeGenBase.megaTaiga, BiomeGenBase.megaTaigaHills, BiomeGenBase.taiga, BiomeGenBase.taigaHills });
        EntityRegistry.registerModEntity(entityclass, name, EntityId, MainClass.instance, 64, 1, true);
        EntityList.entityEggs.put(EntityId, new EntityList.EntityEggInfo(EntityId, mainColor, subColor));
    }
    ...
    public static void registerMermaid(final Class entityclass, final String name) {
        ...
        final int subColor = random.nextInt() * 16777215;
        EntityRegistry.registerGlobalEntityID(entityclass, name, EntityId);
        EntityRegistry.addSpawn(entityclass, 10, 1, 2, EnumCreatureType.waterCreature, new BiomeGenBase[] { BiomeGenBase.ocean, BiomeGenBase.deepOcean });
        EntityRegistry.registerModEntity(entityclass, name, EntityId, MainClass.instance, 64, 1, true);
        EntityList.entityEggs.put(EntityId, new EntityList.EntityEggInfo(EntityId, mainColor, subColor));
    }
    ...
    public static void registerHippocampus(final Class entityclass, final String name) {
        ...
        final int subColor = random.nextInt() * 16777215;
        EntityRegistry.registerGlobalEntityID(entityclass, name, EntityId);
        EntityRegistry.addSpawn(entityclass, 13, 1, 2, EnumCreatureType.waterCreature, new BiomeGenBase[] { BiomeGenBase.ocean, BiomeGenBase.deepOcean });
        EntityRegistry.registerModEntity(entityclass, name, EntityId, MainClass.instance, 64, 1, true);
        EntityList.entityEggs.put(EntityId, new EntityList.EntityEggInfo(EntityId, mainColor, subColor));
    }
    ...
    public static void registerRamora(final Class entityclass, final String name) {
        ...
        final int subColor = random.nextInt() * 16777215;
        EntityRegistry.registerGlobalEntityID(entityclass, name, EntityId);
        EntityRegistry.addSpawn(entityclass, 15, 1, 2, EnumCreatureType.waterCreature, new BiomeGenBase[] { BiomeGenBase.ocean, BiomeGenBase.deepOcean });
        EntityRegistry.registerModEntity(entityclass, name, EntityId, MainClass.instance, 64, 1, true);
        EntityList.entityEggs.put(EntityId, new EntityList.EntityEggInfo(EntityId, mainColor, subColor));
    }
    ...
    public static void registerKelpie(final Class entityclass, final String name) {
        ...
        final int subColor = random.nextInt() * 16777215;
        EntityRegistry.registerGlobalEntityID(entityclass, name, EntityId);
        EntityRegistry.addSpawn(entityclass, 4, 1, 3, EnumCreatureType.waterCreature, new BiomeGenBase[] { BiomeGenBase.river, BiomeGenBase.swampland, BiomeGenBase.ocean });
        EntityRegistry.registerModEntity(entityclass, name, EntityId, MainClass.instance, 64, 1, true);
        EntityList.entityEggs.put(EntityId, new EntityList.EntityEggInfo(EntityId, mainColor, subColor));
    }
