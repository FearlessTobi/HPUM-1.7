...
public class KeyHandler {
	...
	public KeyHandler(final int Key_R, final int Key_C, final int Key_F, final int key_Z, final int Key_X, final int Key_NUMPAD0, final int Key_NUMPAD1, final int Key_NUMPAD2, final int Key_NUMPAD3,
			final int Key_NUMPAD4, final int Key_NUMPAD5, final int Key_NUMPAD6, final int Key_NUMPAD7, final int Key_NUMPAD8, final int Key_NUMPAD9) {
		this.mc = Minecraft.getMinecraft();
		flyup = new KeyBinding("Fly Up", Key_R, "key.categories.movement");
		flydown = new KeyBinding("Fly Down", Key_C, "key.categories.movement");
		special = new KeyBinding("Special", Key_F, "key.categories.gameplay");
		prevwand = new KeyBinding("Previous Spell", key_Z, "key.categories.gameplay");
		nextwand = new KeyBinding("Next Spell", Key_X, "key.categories.gameplay");
		quickspell0 = new KeyBinding("Quick Spell 0", Key_NUMPAD0, "key.categories.gameplay");
		quickspell1 = new KeyBinding("Quick Spell 1", Key_NUMPAD1, "key.categories.gameplay");
		quickspell2 = new KeyBinding("Quick Spell 2", Key_NUMPAD2, "key.categories.gameplay");
		quickspell3 = new KeyBinding("Quick Spell 3", Key_NUMPAD3, "key.categories.gameplay");
		quickspell4 = new KeyBinding("Quick Spell 4", Key_NUMPAD4, "key.categories.gameplay");
		quickspell5 = new KeyBinding("Quick Spell 5", Key_NUMPAD5, "key.categories.gameplay");
		quickspell6 = new KeyBinding("Quick Spell 6", Key_NUMPAD6, "key.categories.gameplay");
		quickspell7 = new KeyBinding("Quick Spell 7", Key_NUMPAD7, "key.categories.gameplay");
		quickspell8 = new KeyBinding("Quick Spell 8", Key_NUMPAD8, "key.categories.gameplay");
		quickspell9 = new KeyBinding("Quick Spell 9", Key_NUMPAD9, "key.categories.gameplay");
	...
	public void onKeyInput(final InputEvent.KeyInputEvent event) {
		final boolean next = nextwand.getIsKeyPressed();
		final boolean prev = prevwand.getIsKeyPressed();
