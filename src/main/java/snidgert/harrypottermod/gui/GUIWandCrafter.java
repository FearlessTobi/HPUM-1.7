...
public class GUIWandCrafter extends GuiContainer
{
	...
	protected void drawGuiContainerForegroundLayer(final int i, final int j) {
        final String name = this.wandcrafter.hasCustomInventoryName() ? this.wandcrafter.getInventoryName() : I18n.format(this.wandcrafter.getInventoryName(), new Object[0]);
