...
public class ElderWandClass extends WoodWandClass {
	...
	public ElderWandClass() {
		this.setTextureName("harrypottermod:ElderWand2");
	...
	public ItemStack onItemRightClick(final ItemStack itemstack, final World world, final EntityPlayer entityplayer) {
		...
		case 1: {
			if (this.getDamage(itemstack) == 1 && !world.isRemote) {
				final List list1 = world.getEntitiesWithinAABB(EntityItem.class, AxisAlignedBB.getBoundingBox(((Entity) entityplayer).posX, ((Entity) entityplayer).posY,
						((Entity) entityplayer).posZ, ((Entity) entityplayer).posX + 1.0, ((Entity) entityplayer).posY + 1.0, ((Entity) entityplayer).posZ + 1.0).expand(50.0, 50.0, 50.0));
				for (int j = 0; j < list1.size(); ++j) {
					final EntityItem entityitem = (EntityItem) list1.get(j);
					if (entityitem != null) {
						world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:WandFlick", 1.0f,
		...
		case 2: {
			if (this.getDamage(itemstack) == 2) {
				world.playSoundEffect(((Entity) entityplayer).posX + 0.2, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:WandFlick", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
				...
				world.spawnParticle("heart", ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width,
						((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d0, d2, d3);
				world.spawnParticle("heart", ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width,
						((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d0, d2, d3);
				world.spawnParticle("heart", ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width,
						((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d0, d2, d3);
		...
		case 3: {
			...
			final double d5 = ((Entity) entityplayer).prevPosY + (((Entity) entityplayer).posY - ((Entity) entityplayer).prevPosY) * f + 1.62 - ((Entity) entityplayer).yOffset;
			final double d6 = ((Entity) entityplayer).prevPosZ + (((Entity) entityplayer).posZ - ((Entity) entityplayer).prevPosZ) * f;
			final Vec3 vec3 = Vec3.createVectorHelper(d4, d5, d6);
			...
			final List list2 = world.getEntitiesWithinAABBExcludingEntity(entityplayer,
					((Entity) entityplayer).boundingBox.addCoord(vec5.xCoord * d7, vec5.yCoord * d7, vec5.zCoord * d7).expand(f10, f10, f10));
			...
			final int l = movingobjectposition.blockZ;
			if (world.getBlock(i, k, l) == Blocks.snow_layer) {
				--k;
			}
			...
			if (!world.getCollidingBoundingBoxes(entityboat, ((Entity) entityboat).boundingBox.expand(-0.1, -0.1, -0.1)).isEmpty()) {
				return itemstack;
			}
			if (!world.isRemote) {
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:WandFlick", 1.0f,
		...
		case 4: {
			...
			int m = movingobjectposition.blockY;
			final int k2 = movingobjectposition.blockZ;
			if (!world.isRemote) {
				final List list3 = world.getEntitiesWithinAABB(EntityNagini.class, AxisAlignedBB.getBoundingBox(h, m, k2, h + 1.0, m + 1.0, k2 + 1.0).expand(2.0, 2.0, 2.0));
			...
			if (world.getBlock(h, m, k2) == Blocks.snow_layer) {
				--m;
			}
			if (world.isAirBlock(h, m + 1, k2)) {
				world.setBlock(h, m + 1, k2, Blocks.lava);
			}
			if (world.isAirBlock(h + 1, m + 1, k2)) {
				world.setBlock(h + 1, m + 1, k2, Blocks.fire);
			}
			if (world.isAirBlock(h - 1, m + 1, k2)) {
				world.setBlock(h - 1, m + 1, k2, Blocks.fire);
			}
			if (world.isAirBlock(h, m + 1, k2 + 1)) {
				world.setBlock(h, m + 1, k2 + 1, Blocks.fire);
			}
			if (world.isAirBlock(h, m + 1, k2 - 1)) {
				world.setBlock(h, m + 1, k2 - 1, Blocks.fire);
			}
			...
			if (!world.getCollidingBoundingBoxes(entityboat2, ((Entity) entityboat2).boundingBox.expand(-0.1, -0.1, -0.1)).isEmpty()) {
				return itemstack;
			}
			if (!world.isRemote) {
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:WandFlick", 1.0f,
		...
		case 6: {
			...
			if (world.getBlock(j2, k3, l2) == Blocks.water) {
				world.setBlock(j2, k3, l2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 + 1, k3, l2) == Blocks.water) {
				world.setBlock(j2 + 1, k3, l2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 + 2, k3, l2) == Blocks.water) {
				world.setBlock(j2 + 2, k3, l2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 - 1, k3, l2) == Blocks.water) {
			...
			if (world.getBlock(j2, k3, l2 - 1) == Blocks.water) {
				world.setBlock(j2, k3, l2 - 1, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2, k3, l2 - 2) == Blocks.water) {
				world.setBlock(j2, k3, l2 - 2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2, k3, l2 + 1) == Blocks.water) {
			...
			if (world.getBlock(j2 + 1, k3, l2 - 1) == Blocks.water) {
				world.setBlock(j2 + 1, k3, l2 - 1, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 + 2, k3, l2 - 1) == Blocks.water) {
				world.setBlock(j2 + 2, k3, l2 - 1, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 - 1, k3, l2 - 1) == Blocks.water) {
			...
			if (world.getBlock(j2 - 1, k3, l2 - 2) == Blocks.water) {
				world.setBlock(j2 - 1, k3, l2 - 2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 + 1, k3, l2 + 1) == Blocks.water) {
			...
			if (world.getBlock(j2 - 2, k3, l2 - 2) == Blocks.water) {
				world.setBlock(j2 - 2, k3, l2 - 2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 + 2, k3, l2 - 2) == Blocks.water) {
			...
			if (world.getBlock(j2, k3 - 1, l2) == Blocks.water) {
				world.setBlock(j2, k3 - 1, l2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 + 1, k3 - 1, l2) == Blocks.water) {
				world.setBlock(j2 + 1, k3 - 1, l2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 + 2, k3 - 1, l2) == Blocks.water) {
				world.setBlock(j2 + 2, k3 - 1, l2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 - 1, k3 - 1, l2) == Blocks.water) {
			...
			if (world.getBlock(j2, k3 - 1, l2 - 1) == Blocks.water) {
				world.setBlock(j2, k3 - 1, l2 - 1, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2, k3 - 1, l2 - 2) == Blocks.water) {
				world.setBlock(j2, k3 - 1, l2 - 2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2, k3 - 1, l2 + 1) == Blocks.water) {
			...
			if (world.getBlock(j2 + 1, k3 - 1, l2 - 1) == Blocks.water) {
				world.setBlock(j2 + 1, k3 - 1, l2 - 1, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 + 2, k3 - 1, l2 - 1) == Blocks.water) {
				world.setBlock(j2 + 2, k3 - 1, l2 - 1, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 - 1, k3 - 1, l2 - 1) == Blocks.water) {
			...
			if (world.getBlock(j2 - 1, k3 - 1, l2 - 2) == Blocks.water) {
				world.setBlock(j2 - 1, k3 - 1, l2 - 2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 + 1, k3 - 1, l2 + 1) == Blocks.water) {
			...
			if (world.getBlock(j2 - 2, k3 - 1, l2 - 2) == Blocks.water) {
				world.setBlock(j2 - 2, k3 - 1, l2 - 2, Blocks.ice);
				world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
						Item.itemRand.nextFloat() * 0.4f + 0.8f);
			}
			if (world.getBlock(j2 + 2, k3 - 1, l2 - 2) == Blocks.water) {
		...
		case 10: {
			...
			entityboat3.func_152115_b(entityplayer.getUniqueID().toString());
			entityboat3.setTamed(true);
			if (!world.getCollidingBoundingBoxes(entityboat3, ((Entity) entityboat3).boundingBox.expand(-0.1, -0.1, -0.1)).isEmpty()) {
				return itemstack;
			}
			if (!world.isRemote) {
		...
		case 11: {
			...
			final int h = movingobjectposition.blockX;
			final int m = movingobjectposition.blockY;
			final int k2 = movingobjectposition.blockZ;
			if (world.isAirBlock(h, m + 1, k2)) {
				world.setBlock(h, m + 1, k2, Blocks.flowing_water);
			}
			break Label_33472;
		}
		case 12: {
			...
			final int k2 = movingobjectposition.blockZ;
			if (world.isAirBlock(h, m + 1, k2)) {
				world.setBlock(h, m + 1, k2, Blocks.red_flower);
			}
			break Label_33472;
		}
		case 13: {
			...
			final int m = movingobjectposition.blockY;
			final int k2 = movingobjectposition.blockZ;
			if (world.getBlock(h, m, k2) == Blocks.iron_door) {
				final int id = world.getBlockMetadata(h, m, k2);
				int j3 = 2;
				j3 ^= 0x4;
				switch (id) {
				case 0: {
					world.setBlockMetadataWithNotify(h, m, k2, j3 - 2, 2);
					break;
				}
				case 1: {
					world.setBlockMetadataWithNotify(h, m, k2, j3 - 1, 2);
					break;
				}
				case 2: {
					world.setBlockMetadataWithNotify(h, m, k2, j3, 2);
					break;
				}
				case 3: {
					world.setBlockMetadataWithNotify(h, m, k2, j3 + 1, 2);
				...
				case 4: {
					world.setBlockMetadataWithNotify(h, m, k2, j3 + 10, 2);
					break;
				}
				case 5: {
					world.setBlockMetadataWithNotify(h, m, k2, j3 + 11, 2);
					break;
				}
				case 6: {
					world.setBlockMetadataWithNotify(h, m, k2, j3 - 4, 2);
					break;
				}
				case 7: {
					world.setBlockMetadataWithNotify(h, m, k2, j3 - 3, 2);
					break;
				}
				}
			...
			if (world.isAirBlock(h, m + 1, k2)) {
				...
				world.setBlock(h, m + 1, k2, Blocks.redstone_torch);
			}
			break Label_33472;
		}
		case 14: {
		...
		case 30: {
			...
			final int k2 = movingobjectposition.blockZ;
			if (world.isAirBlock(h, m + 1, k2)) {
				world.setBlock(h, m + 1, k2, MainClass.DarkMark);
			}
			break Label_33472;
		}
		case 31: {
		...
		case 40: {
			if (this.getDamage(itemstack) == 40 && !world.isRemote) {
				final List list1 = world.getEntitiesWithinAABB(EntityBoggartDementor.class, AxisAlignedBB.getBoundingBox(((Entity) entityplayer).posX, ((Entity) entityplayer).posY,
						((Entity) entityplayer).posZ, ((Entity) entityplayer).posX + 1.0, ((Entity) entityplayer).posY + 1.0, ((Entity) entityplayer).posZ + 1.0).expand(8.0, 8.0, 8.0));
				for (int j = 0; j < list1.size(); ++j) {
	...
	public void onPlayerStoppedUsing(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer, final int par4) {
		...
		par2World.playSoundEffect(((Entity) par3EntityPlayer).posX + 0.5, ((Entity) par3EntityPlayer).posY + 0.5, ((Entity) par3EntityPlayer).posZ + 0.5, "harrypottermod:WandAttack", 1.0f,
				Item.itemRand.nextFloat() * 0.4f + 0.8f);
		if (this.getDamage(par1ItemStack) == 15 && !par2World.isRemote) {
			...
			fireball2.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + 1.0 + look.yCoord * 2.0 + 1.0,
					((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 16 && !par2World.isRemote) {
			...
			fireball3.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 17 && !par2World.isRemote) {
			...
			fireball4.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 18 && !par2World.isRemote) {
			...
			fireball5.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 19 && !par2World.isRemote) {
			...
			fireball6.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 20 && !par2World.isRemote) {
			...
			fireball7.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 22 && !par2World.isRemote) {
			...
			fireball8.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 23 && !par2World.isRemote) {
			...
			fireball9.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 24 && !par2World.isRemote) {
			...
			fireball10.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + 1.0 + look.yCoord * 2.0,
					((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 25 && !par2World.isRemote) {
			...
			fireball11.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + 1.0 + look.yCoord * 2.0,
					((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 26 && !par2World.isRemote) {
			...
			fireball12.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 27 && !par2World.isRemote) {
			...
			fireball13.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 28 && !par2World.isRemote) {
			...
			fireball14.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 29 && !par2World.isRemote) {
			...
			fireball15.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + look.yCoord * 2.0, ((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
