...
public class SupportWandClass extends Item {
			...
			Label_11551: {
				...
				case 3: {
					if (this.getDamage(itemstack) == 3) {
						...
						if (world.getBlock(i, k, l) == Blocks.water) {
							world.setBlock(i, k, l, Blocks.ice);
						...
						if (world.getBlock(i + 1, k, l) == Blocks.water) {
							world.setBlock(i + 1, k, l, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i + 2, k, l) == Blocks.water) {
							world.setBlock(i + 2, k, l, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i - 1, k, l) == Blocks.water) {
						...
						if (world.getBlock(i, k, l - 1) == Blocks.water) {
							world.setBlock(i, k, l - 1, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i, k, l - 2) == Blocks.water) {
							world.setBlock(i, k, l - 2, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i, k, l + 1) == Blocks.water) {
						...
						if (world.getBlock(i + 1, k, l - 1) == Blocks.water) {
							world.setBlock(i + 1, k, l - 1, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i + 2, k, l - 1) == Blocks.water) {
							world.setBlock(i + 2, k, l - 1, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i - 1, k, l - 1) == Blocks.water) {
						...
						if (world.getBlock(i - 1, k, l - 2) == Blocks.water) {
							world.setBlock(i - 1, k, l - 2, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i + 1, k, l + 1) == Blocks.water) {
						...
						if (world.getBlock(i - 2, k, l - 2) == Blocks.water) {
							world.setBlock(i - 2, k, l - 2, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i + 2, k, l - 2) == Blocks.water) {
						...
						if (world.getBlock(i, k - 1, l) == Blocks.water) {
							world.setBlock(i, k - 1, l, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i + 1, k - 1, l) == Blocks.water) {
							world.setBlock(i + 1, k - 1, l, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i + 2, k - 1, l) == Blocks.water) {
							world.setBlock(i + 2, k - 1, l, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i - 1, k - 1, l) == Blocks.water) {
						...
						if (world.getBlock(i, k - 1, l - 1) == Blocks.water) {
							world.setBlock(i, k - 1, l - 1, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i, k - 1, l - 2) == Blocks.water) {
							world.setBlock(i, k - 1, l - 2, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i, k - 1, l + 1) == Blocks.water) {
						...
						if (world.getBlock(i + 1, k - 1, l - 1) == Blocks.water) {
							world.setBlock(i + 1, k - 1, l - 1, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i + 2, k - 1, l - 1) == Blocks.water) {
							world.setBlock(i + 2, k - 1, l - 1, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i - 1, k - 1, l - 1) == Blocks.water) {
						...
						if (world.getBlock(i - 1, k - 1, l - 2) == Blocks.water) {
							world.setBlock(i - 1, k - 1, l - 2, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i + 1, k - 1, l + 1) == Blocks.water) {
						...
						if (world.getBlock(i - 2, k - 1, l - 2) == Blocks.water) {
							world.setBlock(i - 2, k - 1, l - 2, Blocks.ice);
							world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:IceFreeze", 1.0f,
									Item.itemRand.nextFloat() * 0.4f + 0.8f);
						}
						if (world.getBlock(i + 2, k - 1, l - 2) == Blocks.water) {
				...
				case 5: {
					...
					final List list2 = world.getEntitiesWithinAABBExcludingEntity(entityplayer,
							((Entity) entityplayer).boundingBox.addCoord(vec5.xCoord * d4, vec5.yCoord * d4, vec5.zCoord * d4).expand(f10, f10, f10));
					...
					final int j2 = movingobjectposition.blockY;
					final int k2 = movingobjectposition.blockZ;
					if (world.isAirBlock(h, j2 + 1, k2)) {
						world.setBlock(h, j2 + 1, k2, Blocks.flowing_water);
				...
				case 6: {
					...
					final int k2 = movingobjectposition.blockZ;
					if (world.isAirBlock(h, j2 + 1, k2)) {
						world.setBlock(h, j2 + 1, k2, Blocks.red_flower);
				...
				case 7: {
					...
					final int j2 = movingobjectposition.blockY;
					final int k2 = movingobjectposition.blockZ;
					if (world.getBlock(h, j2, k2) == Blocks.iron_door) {
						final int id = world.getBlockMetadata(h, j2, k2);
						int j3 = 2;
						j3 ^= 0x4;
						switch (id) {
						case 0: {
							world.setBlockMetadataWithNotify(h, j2, k2, j3 - 2, 2);
							break;
						}
						case 1: {
							world.setBlockMetadataWithNotify(h, j2, k2, j3 - 1, 2);
							break;
						}
						case 2: {
							world.setBlockMetadataWithNotify(h, j2, k2, j3, 2);
							break;
						}
						case 3: {
							world.setBlockMetadataWithNotify(h, j2, k2, j3 + 1, 2);
						...
						case 4: {
							world.setBlockMetadataWithNotify(h, j2, k2, j3 + 10, 2);
							break;
						}
						case 5: {
							world.setBlockMetadataWithNotify(h, j2, k2, j3 + 11, 2);
							break;
						}
						case 6: {
							world.setBlockMetadataWithNotify(h, j2, k2, j3 - 4, 2);
							break;
						}
						case 7: {
							world.setBlockMetadataWithNotify(h, j2, k2, j3 - 3, 2);
							break;
						}
						}
						world.markBlockRangeForRenderUpdate(h, j2, k2, h, j2, k2);

						break Label_11551;
					}
					if (world.isAirBlock(h, j2 + 1, k2)) {
						world.playSoundEffect(h + 0.5, j2 + 0.5, k2 + 0.5, "harrypottermod:WandFlick", 1.0f, Item.itemRand.nextFloat() * 0.4f + 0.8f);
						world.setBlock(h, j2 + 1, k2, Blocks.redstone_torch);
				...
				case 8: {
					if (this.getDamage(itemstack) == 8) {
						...
						entityplayer.setPosition(((Entity) entityplayer).posX + look.xCoord * 30.0, ((Entity) entityplayer).posY + look.yCoord * 30.0,
								((Entity) entityplayer).posZ + look.zCoord * 30.0);
				...
				case 10: {
					...
					int m = movingobjectposition.blockX;
					int j4 = movingobjectposition.blockY;
					final int k3 = movingobjectposition.blockZ;
					if (world.getBlock(m, j4, k3) == Blocks.snow_layer) {
						--j4;
					}
				...
				case 11: {
					...
					entityboat2.func_152115_b(entityplayer.getUniqueID().toString());
				...
				case 12: {
					if (this.getDamage(itemstack) == 12 && !world.isRemote) {
						...
						world.playSoundEffect(((Entity) entityplayer).posX + 0.5, ((Entity) entityplayer).posY + 0.5, ((Entity) entityplayer).posZ + 0.5, "harrypottermod:WandFlick", 1.0f,
								Item.itemRand.nextFloat() * 0.4f + 0.8f);
						final List list1 = world.getEntitiesWithinAABB(EntityLivingBase.class, AxisAlignedBB.getBoundingBox(((Entity) entityplayer).posX, ((Entity) entityplayer).posY,
								((Entity) entityplayer).posZ, ((Entity) entityplayer).posX + 1.0, ((Entity) entityplayer).posY + 1.0, ((Entity) entityplayer).posZ + 1.0).expand(10.0, 5.0, 10.0));
						for (int j = 0; j < list1.size(); ++j) {
				...
				case 13: {
					...
					world.spawnParticle("heart", ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width,
							((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d5, d6, d7);
					world.spawnParticle("heart", ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width,
							((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d5, d6, d7);
					world.spawnParticle("heart", ((Entity) entityplayer).posX + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width,
							((Entity) entityplayer).posY, ((Entity) entityplayer).posZ + Item.itemRand.nextFloat() * ((Entity) entityplayer).width * 2.0f - ((Entity) entityplayer).width, d5, d6, d7);
					...
					if (!world.isRemote) {
						final List list3 = world.getEntitiesWithinAABB(EntityLivingBase.class, AxisAlignedBB.getBoundingBox(((Entity) entityplayer).posX, ((Entity) entityplayer).posY,
								((Entity) entityplayer).posZ, ((Entity) entityplayer).posX + 1.0, ((Entity) entityplayer).posY + 1.0, ((Entity) entityplayer).posZ + 1.0).expand(10.0, 5.0, 10.0));
				...
				case 24: {
					...
					final int k2 = movingobjectposition.blockZ;
					if (world.isAirBlock(h, j2 + 1, k2)) {
						world.setBlock(h, j2 + 1, k2, MainClass.DarkMark);
	...
	public void onPlayerStoppedUsing(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer, final int par4) {
		...
		if (this.getDamage(par1ItemStack) == 19 && !par2World.isRemote) {
			...
			fireball4.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + 1.0 + look.yCoord * 2.0,
					((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 20 && !par2World.isRemote) {
			...
			fireball5.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + 1.0 + look.yCoord * 2.0,
					((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 21 && !par2World.isRemote) {
			...
			fireball6.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + 1.0 + look.yCoord * 2.0,
					((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 22 && !par2World.isRemote) {
			...
			fireball7.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + 1.0 + look.yCoord * 2.0,
					((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
		...
		if (this.getDamage(par1ItemStack) == 23 && !par2World.isRemote) {
			...
			fireball8.setPosition(((Entity) par3EntityPlayer).posX + look.xCoord * 2.0, ((Entity) par3EntityPlayer).posY + 1.0 + look.yCoord * 2.0,
					((Entity) par3EntityPlayer).posZ + look.zCoord * 2.0);
