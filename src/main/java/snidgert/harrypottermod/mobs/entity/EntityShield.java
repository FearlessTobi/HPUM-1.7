...
public class EntityShield extends EntityAnimal
{
	...
	public void onUpdate() {
        ...
        final List list1 = this.worldObj.getEntitiesWithinAABB(EntityFireball.class, AxisAlignedBB.getBoundingBox(this.posX, this.posY, this.posZ, this.posX + 1.0, this.posY + 1.0, this.posZ + 1.0).expand(5.0, 5.0, 5.0));
