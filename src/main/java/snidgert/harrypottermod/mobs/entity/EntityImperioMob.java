...
public class EntityImperioMob extends EntityWolfBase
{
	...
	protected String getLivingSound() {
		return isAngry() ? "mob.zombie.growl" : ((rand.nextInt(3) == 0) ? ((isTamed() && dataWatcher.getWatchableObjectFloat(18) < 10.0f) ? "mob.zombie.whine" : "mob.zombie.panting") : "mob.wolf.bark");
	}
	...
	public void onUpdate() {
		super.onUpdate();
		final List list1 = worldObj.getEntitiesWithinAABB(EntityLiving.class, AxisAlignedBB.getBoundingBox(posX, posY, posZ, posX + 1.0, posY + 1.0, posZ + 1.0).expand(1.0, 1.0, 1.0));
