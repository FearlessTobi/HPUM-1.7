...
public class EntityPhoenix extends EntityGolem
{
	...
	public boolean isBurning() {
        final List list1 = this.worldObj.getEntitiesWithinAABB(EntityLiving.class, AxisAlignedBB.getBoundingBox(this.posX, this.posY, this.posZ, this.posX + 1.0, this.posY + 1.0, this.posZ + 1.0).expand(10.0, 10.0, 10.0));
